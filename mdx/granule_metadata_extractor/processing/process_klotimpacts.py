...
class ExtractKlotimpactsMetadata(ExtractNetCDFMetadata):
    """
    A class to extract klotimpacts
    """
...
if __name__ == '__main__':
    ...
    path_to_file = "../../test/fixtures/IMPACTS_nexrad_20200108_010757_klot.nc"
    exnet = ExtractKlotimpactsMetadata(path_to_file)
