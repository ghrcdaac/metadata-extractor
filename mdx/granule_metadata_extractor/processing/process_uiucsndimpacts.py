...
class ExtractUiucsndimpactsMetadata(ExtractNetCDFMetadata):
    """
    ...
    def get_variables_min_max(self, variable_key):
        ...
        self.minTime, self.maxTime = [reftime + timedelta(seconds=minsec), reftime + timedelta(seconds=maxsec)]
...
if __name__ == '__main__':
    print('Extracting Uiucsndimpacts Metadata')
    file_path = "/home/lwang13/GHRCCLOUD/granule-metadata-extractor/test/fixtures" \
                "/IMPACTS_UIUC_Mobile_research_sounding_20200118_1600.nc"
