...
class ExtractAsosimpactsMetadata(ExtractNetCDFMetadata):
    """
    A class to extract asosimpacts 
    """
...
if __name__ == '__main__':
    ...
    path_to_file = "../../test/fixtures/IMPACTS_ASOS_20200111_kadg.nc"
    exnet = ExtractAsosimpactsMetadata(path_to_file)
