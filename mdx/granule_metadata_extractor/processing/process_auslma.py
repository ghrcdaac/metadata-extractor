...
class ExtractAuslmaMetadata(ExtractASCIIMetadata):
    """
    A class to extract auslma granule metadata
    """
    ...
    def get_variables_min_max(self, **kwargs):
        """
        Extracts temporal and spatial metadata from auslma granules
        """

        if self.file_name.startswith('IGNIS'):
            ...
            raise ValueError(f"Unrecognized file type: {self.file_name}")
...
if __name__ == '__main__':
    print('Extracting auslma Metadata')
