...
#Exclude all data located more than 200 km from MALMA center point
north0, south0, east0, west0 = [40.374, 36.776, -74.104, -78.705]

class ExtractMalmaMetadata(ExtractASCIIMetadata):
    """
    A class to extract malma granule metadata
    """
...
if __name__ == '__main__':
    print('Extracting Malma Metadata')
