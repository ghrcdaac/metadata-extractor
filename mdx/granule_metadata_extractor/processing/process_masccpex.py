...
class ExtractMasccpexMetadata(ExtractNetCDFMetadata):
    """
    A class to extract masccpex
    """
    ...
    def get_variables_min_max(self):
        ...
        utc_sec0 = np.array(fp['time']).ravel() #Seconds since 1,1,1970, flattened 2d to 1d
