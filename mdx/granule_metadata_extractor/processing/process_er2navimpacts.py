...
class ExtractEr2navimpactsMetadata(ExtractASCIIMetadata):
    """
    A class to extract er2navimpacts 
    """
...
if __name__ == '__main__':
    print('Extracting er2navimpacts Metadata')
    path_to_file = "../../test/fixtures/IMPACTS_MetNav_ER2_20200225_R0.ict"
    exnet = ExtractEr2navimpactsMetadata(path_to_file)
