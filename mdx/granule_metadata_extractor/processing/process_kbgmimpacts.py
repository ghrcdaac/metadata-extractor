...
if __name__ == '__main__':
    print('Extracting kbgmimpacts Metadata')
    path_to_file = "/ftp/ops/public/pub/fieldCampaigns/impacts/NEXRAD/KBGM/data/20200111/IMPACTS_nexrad_20200111_003544_kbgm.nc"
    exnet = ExtractKbgmimpactsMetadata(path_to_file)
