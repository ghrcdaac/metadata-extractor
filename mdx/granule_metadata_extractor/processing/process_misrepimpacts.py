...
class ExtractMisrepimpactsMetadata(ExtractASCIIMetadata):
    """
    A class to extract misrepimpacts
    """
    ...
    def get_variables_min_max(self, **kwargs):
        """
        Gets start/end time and lat/lon of misrepimpacts file
        :return:
        """
...
if __name__ == '__main__':
    print('Extracting Misrepimpacts Metadata')
    path_to_file = '~/Downloads/IMPACTS_planOfTheDay_20200108.pdf'
    exnet = ExtractMisrepimpactsMetadata(path_to_file)
    metadata = exnet.get_metadata("test")
