...
class ExtractMetnavcpexcvMetadata(ExtractASCIIMetadata):
    """
    ...
    def get_variables_min_max(self):
        ...
        """
        #sample file:
        #CPEXCV_MetNav_DC8_20220906_R0.ict
        ...
        for line in lines[num_header_lines:]:
            ...
            tkn = line.split(',')
            utc = datetime(int(2022),1,1)+timedelta(days=int(tkn[1])-1)+timedelta(seconds=int(tkn[0]))
            utc_time.append(utc)
