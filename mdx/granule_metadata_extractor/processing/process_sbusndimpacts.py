...
class ExtractSbusndimpactsMetadata(ExtractNetCDFMetadata):
    """
    A class to extract sbusndimpacts 
    """
    ...
    def get_variables_min_max(self, nc, file_path):
        ...
        :return:
        """
        date_str = file_path.split('/')[-1].split('_')[2]
        ...
        #utc_sec = np.array(nc.variables['time'])
