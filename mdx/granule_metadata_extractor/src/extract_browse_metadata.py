...
class ExtractBrowseMetadata(MetadataExtractor):
    """
    Class to extract BROWSE metadata
    """
    ...
    @abstractmethod
    def get_metadata(self, ds_short_name, format='BROWSE', version='1'):
        """
...
if __name__ == '__main__':
    ...
    exnet = ExtractBrowseMetadata(file_path)
