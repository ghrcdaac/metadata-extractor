# create lookup zip for cplwhymsie
...
short_name = "cplwhymsie"
provider_path = "cplwhymsie/"
file_type = "HDF-5"
...
class MDXProcessing(MDX):
    ...
    def process(self, filename, file_obj_stream) -> dict:
        ...
        if '_L1B_' in filename:
            return self.get_L1B_metadata(filename, file_obj_stream)
        else:
            return self.get_L2Lay_L2Pro_metadata(filename, file_obj_stream)


    def get_L1B_metadata(self, filename, file_obj_stream):
        """
        Extract temporal and spatial metadata from '*_L1B_*' HDF-5 files
        """
        #Sample file
        #WHyMSIE_CPL_L1B_ER2_20241023_R0.h5
        ...
        obs_date = filename.split('/')[-1].split('_')[4][0:8] #i.e., 20241023
    ...
    def get_L2Lay_L2Pro_metadata(self, filename, file_obj_stream):
        """
        ...
        if '_L2Pro_' in filename:
            key = 'profile'
        elif '_L2Lay_' in filename:
