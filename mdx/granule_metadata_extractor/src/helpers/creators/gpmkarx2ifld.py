...
# https://ghrc.nsstc.nasa.gov/hydro/details/gpmkarx2ifld
nlat = 47.96
slat = 39.68
elon = -85.47
wlon = -96.92
...
if __name__ == "__main__":
    file_dir = "/ftp/ops/public/pub/fieldCampaigns/gpmValidation/ifloods/NEXRAD2/KARX/data/"
    #(1) read in metadata Mary extracted from database
    with open('gpmkarx2ifld_dbmeta_redone','r') as fp:
         dbmeta = json.load(fp)

    #(2) read the list of renamed files
    rn_files, old_files, new_files = load_renaming_script('KARX_renaming_script')
    ...
    with open('../gpmkarx2ifldRefData.json', 'w') as fp:
