# create lookup zip for mbarswhymsie
...
short_name = "mbarswhymsie"
provider_path = "mbarswhymsie/"
file_type = "HDF-5"
...
class MDXProcessing(MDX):
    ...
    def get_hdf5_metadata(self, filename, file_obj_stream):
        ...
        lat = navgrp.variables['Latitude'][:]
        lon = navgrp.variables['Longitude'][:]
        tgrp = h5.groups['Time']
        tm = tgrp.variables['TimeUTC'][:]
