"""Creator for Cloud Cube NURTURE."""
...
short_name = "cloudcubenurture"
provider_path = "cloudcubenurture/"
...
class MDXProcessing(MDX):
    ...
    def process(self, filename, file_obj_stream) -> dict:
        ...
        with (h5netcdf.File(file_buffer, "r") as nc):
            ...
            start = datetime.strptime(attrs["time_coverage_start"], "%Y-%m-%d %H:%M:%S")
            end = datetime.strptime(attrs["time_coverage_end"], "%Y-%m-%d %H:%M:%S")
