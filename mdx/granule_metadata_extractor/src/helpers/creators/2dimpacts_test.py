...
from utils.mdx_test import MDX
import cProfile
import time
import math
import re
...
provider_path = "/home/dev/Downloads/2dimpacts"
file_type = "ASCII"
...
class MDXProcessing(MDX):
    ...
    def process(self, filename, file_lines) -> dict:
        """
        ...
        if 'diameter020' in filename:
            ...
            return self.read_metadata_raintotalhour(filename, file_lines)
        else:
            return self.read_metadata_regular(filename, file_lines)
    ...
    def read_metadata_raintotalhour(self, filename, file_lines):
        """
    ...
    def read_metadata_regular(self, filename, file_lines):
        """
