# create lookup zip for cosmirv2whymsie 
...
class MDXProcessing(MDX):
    ...
    def get_nc_metadata(self, filename, file_obj_stream):
        ...
        if len(utc) > 0:
           ...
           #whymsie_cosmirh_20241113_S184902_E191905_cross_track_v2.nc
           #All time vlues are missing in this file
           tkn = filename.split('_')
           start_time = datetime.strptime(tkn[2]+tkn[3],'%Y%m%dS%H%M%S')
           end_time = datetime.strptime(tkn[2]+tkn[4],'%Y%m%dE%H%M%S')
