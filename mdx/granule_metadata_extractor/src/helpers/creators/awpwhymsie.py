# create lookup zip for awpwhymsie 
...
short_name = "awpwhymsie"
provider_path = "awpwhymsie/"
...
class MDXProcessing(MDX):
    ...
    def get_nc_metadata(self, filename, file_obj_stream):
        ...
        #units: seconds since 2024-09-26 00:00:00
        ref_time = datetime.strptime(datafile['time'].units,'seconds since %Y-%m-%d %H:%M:%S') 
