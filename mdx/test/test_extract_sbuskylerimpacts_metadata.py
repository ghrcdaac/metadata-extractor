...
class TestProcessSbuskylerimpacts(TestCase):
    """
    Test processing.
    This will test if metadata will be extracted correctly
    """
    granule_name = "IMPACTS_SBU_skyler1_20220218_055831_rhi_mid.nc"
    ...
    md = process_dataset.get_metadata(ds_short_name= 'sbuskylerimpacts')
    expected_metadata = {'ShortName': 'sbuskylerimpacts',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2022-02-18T05:58:31Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2022-02-18T05:59:04Z")
    ...
    #NLat=40.89656448364258,SLat=40.8224983215332,WLon=-73.12458038330078,ELon=-72.78557586669922
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='sbuskylerimpacts',
