...
class TestProcessDc8lase(TestCase):
    ...
    process_goesrpltcrs = mdx.ExtractDc8laseMetadata(input_file)
    expected_metadata = {'ShortName': 'dc8lase',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "1998-08-21T17:38:27Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "1998-08-22T02:31:27Z")
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '637d6ad22b883e57a4822cf35634bfdc')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_goesrpltcrs.get_metadata(ds_short_name='dc8lase',
