...
class TestProcessGpmkerlpvex(TestCase):
    """
    Test processing the dataset.
    This will test if metadata will be extracted correctly
    """
    granule_name = "lpvex_RADAR_KERAVA_UF_20100921.tar.gz"
    ...
    process_dataset = ExtractGpmkerlpvexMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'gpmkerlpvex')
    expected_metadata = {'ShortName': 'gpmkerlpvex',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2010-09-21T00:00:04Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2010-09-22T00:00:00Z")
    ...
    def test_3_get_file_size(self):
        ...
        self.assertEqual(file_size, 3260.2)
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, 'c850bca1f6104b55c752f4abe594881b')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='gpmkerlpvex',
