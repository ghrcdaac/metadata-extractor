...
from mdx.granule_metadata_extractor.processing.process_gpmsatpaifld_png import ExtractGpmsatpaifldPNGMetadata
...
class TestProcessGpmsat(TestCase):
    """
    Test processing GpmsatpaifldPNG.
    This will test if Gpmsatpaifld PNG metadata will be extracted correctly
    """
    granule_name = "ifloods_sat_passes_20130401.png"
    ...
    process_goesrpltcrs = ExtractGpmsatpaifldPNGMetadata(input_file)
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '3d30d79c48c240791d0eca2a31f63a87')
