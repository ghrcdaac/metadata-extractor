...
class TestProcessGpmvanlpvex(TestCase):
    """
    Test processing the dataset.
    This will test if metadata will be extracted correctly
    """
    granule_name = "lpvex_RADAR_VANTAA_RAW_20100916.tar.gz"
    ...
    process_dataset = ExtractGpmvanlpvexMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'gpmvanlpvex')
    expected_metadata = {'ShortName': 'gpmvanlpvex',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2010-09-16T00:00:00Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2010-09-16T23:59:59Z")
    ...
    def test_3_get_file_size(self):
        ...
        self.assertEqual(file_size, 1272.95)
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, 'a494e469d7923da270229515141b35f4')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='gpmvanlpvex',
