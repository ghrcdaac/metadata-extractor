...
class TestProcessGoescpexcv(TestCase):
    ...
    """
    granule_name = "cpexcv_CLAVRX_GOES16_Satellite_202209230010_R0.nc"
    ...
    process_dataset = ExtractGoescpexcvMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'goescpexcv')
    expected_metadata = {'ShortName': 'goescpexcv',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2022-09-23T00:10:40Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2022-09-23T00:14:47Z")
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '30b33677843b02f350547886c3d1e4ef')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='goescpexcv',
