...
class TestProcessGlmgoesL3(TestCase):
    """
    Test processing glmgoesL3 for nc file
    This will test if glmgoesL3 metadata will be extracted correctly
    """
    granule_name = "OR_GLM-L4-GLMF-M6_G16_s202210100580000_e202210100590000_c20221010059530.nc"
    ...
    process_instance = ExtractGlmgoesL3Metadata(input_file)

    md = process_instance.get_metadata(ds_short_name= 'glmgoesL3')
    expected_metadata = {'ShortName': 'glmgoesL3',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2022-04-11T00:58:00Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2022-04-11T00:59:00Z")
    ...
    #NLat=81.14754059094562,SLat=-81.14754059094562,WLon=-156.18945874874964,ELon=6.189458748749635
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, 'e68e016bec7dbb18847a183a493029a6')

    def test_9_generate_metadata(self):
        """
        :return: metadata object 
        """
        metadata = self.process_instance.get_metadata(ds_short_name='glmgoesL3',
