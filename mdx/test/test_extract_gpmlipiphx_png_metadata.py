...
from mdx.granule_metadata_extractor.processing.process_gpmlipiphx_png import ExtractGpmlipiphxPNGMetadata
...
class TestProcess(TestCase):
    """
    Test processing PNG.
    This will test if this dataset's PNG metadata will be extracted correctly
    """
    granule_name = "iphex_lip_14121_01.png"
    ...
    process_dataset = ExtractGpmlipiphxPNGMetadata(input_file)
...
#"NLat": 36.4756, "SLat": 34.1076, "ELon": -117.9568, "WLon": -121.853
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '32d5b424478590ebfe69cb89c4bd3395')
