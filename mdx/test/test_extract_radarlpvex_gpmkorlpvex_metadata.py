...
from mdx.granule_metadata_extractor.processing.process_radarlpvex_gpmkorlpvex import ExtractGpmkorlpvexMetadata
...
class TestProcessGpmkorlpvex(TestCase):
    """
    Test processing the dataset.
    This will test if metadata will be extracted correctly
    """
    granule_name = "lpvex_RADAR_KORPO_UF_20101019.tar.gz"
    ...
    process_dataset = ExtractGpmkorlpvexMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'gpmkorlpvex')
    expected_metadata = {'ShortName': 'gpmkorlpvex',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2010-10-19T07:00:00Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2010-10-19T11:05:59Z")
    ...
    def test_3_get_file_size(self):
        ...
        self.assertEqual(file_size, 120.09)
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '3d2d90807aebbc80d62101f5ce8cf74e')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='gpmkorlpvex',
