...
from mdx.granule_metadata_extractor.processing.process_hiwat import ExtractHiwatMetadata
...
class TestProcessHiwat_netcdf(TestCase):
    ...
    process_dataset = ExtractHiwatMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'hiwat')
    expected_metadata = {'ShortName': 'hiwat',
    ...
    #19.958542 31.679443 79.31348 94.70499
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='hiwat',
