...
from mdx.granule_metadata_extractor.processing.process_sbuparsimpacts import ExtractSbuparsimpactsMetadata
...
class TestProcessSbuparsimpactsNetCDF(TestCase):
    ...
    """
    granule_name = "IMPACTS_SBU_parsivel_20200224_SB.nc"
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2020-02-24T13:06:00Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2020-02-24T23:59:00Z")
    ...
    def test_3_get_file_size(self):
        ...
        self.assertEqual(file_size, 2.72)
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '26a949f159f714ebbafea42c44d130d3')
