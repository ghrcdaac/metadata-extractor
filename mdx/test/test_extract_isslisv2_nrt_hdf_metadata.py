...
class TestProcessIsslisv2(TestCase):
    """
    Test processing isslisv2.
    This will test if isslisv2 metadata will be extracted correctly
    """
    granule_name = "ISS_LIS_SC_V2.0_20210628_142555_NRT.hdf"
    ...
    process_isslisv2 = ExtractIsslisv1Metadata(input_file)
    # test for NRT HDF4 file
    md = process_isslisv2.get_metadata(ds_short_name='isslis_v2_nrt')
    expected_metadata = {'ShortName': 'isslis_v2_nrt',
    ...
    def test_1_get_start_date(self):
        ...
        :return:
        """
        start_date = self.process_isslisv2.get_temporal()[0]
    ...
    def test_2_get_stop_date(self):
        ...
        :return:
        """
        stop_date = self.process_isslisv2.get_temporal()[1]
    ...
    def get_wnes(self, index):
        ...
        """
        process_isslis = self.process_isslisv2
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '71d404ad150d80bb69eefbb9a9260bc4')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_isslisv2.get_metadata(ds_short_name='isslis_v2_nrt',
