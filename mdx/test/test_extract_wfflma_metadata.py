...
from granule_metadata_extractor.processing.process_wfflma import ExtractWfflmaMetadata
from granule_metadata_extractor.src.generate_umm_g_json import GenerateUmmGJson

#WFF_250514_063000_0600.dat.gz
#{'start': '2025-05-14T06:30:12Z', 'end': '2025-05-14T06:39:58Z', 'north': '39.891', 'south': '36.294', 'east': '-73.304', 'west': '-77.875', 'format': 'ASCII', 'sizeMB': 0.63}
class TestProcess(TestCase):
    """
    Test processing WFFLMA 
    ...
    process = ExtractWfflmaMetadata(input_file)
    expected_metadata = {'ShortName': 'wfflma',
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process.get_metadata(ds_short_name='wfflma',
