...
from mdx.granule_metadata_extractor.processing.process_lislipG import ExtractLislipGMetadata
from mdx.granule_metadata_extractor.src.generate_umm_g_json import GenerateUmmGJson

#host=thor,env=ops,project=LIS,ds=lislipG,inv=inventory,file=TRMM_LIS_BG.04.1_2002.277.27868.nc,path=nc/2002/1004/TRMM_LIS_BG.04.1_2002.277.27868.nc,size=147171,start=2002-10-05T00:00:03Z,end=2002-10-05T00:02:51Z,browse=N,checksum=073e735581dc040ca1514fcc9521f815f9872aa5,NLat=-34.828678131103516,SLat=-35.05946731567383,WLon=-146.67478942871094,ELon=-141.45120239257812,format=netCDF-4
...
class TestProcessLislipiG(TestCase):
    ...
    """
    granule_name = "TRMM_LIS_BG.04.1_2002.277.27868.nc"
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, 'ee9e51ae3e431cd1a9ab93a1771319be')
