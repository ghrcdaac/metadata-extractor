...
#host=thor,env=ops,project=LIS,ds=lislip,inv=inventory,file=TRMM_LIS_SC.04.1_2002.277.27868,path=hdf/2002/1004/TRMM_LIS_SC.04.1_2002.277.27868,size=38846,start=2002-10-05T00:00:03Z,end=2002-10-05T00:02:51Z,browse=Y,checksum=8c106485deda190e9050d677fa62af838552d2e5,NLat=-34.828678131103516,SLat=-35.05946731567383,WLon=-146.67478942871094,ELon=-141.45120239257812,format=HDF-4

# note: testing four isslis science files. Uncomment each set for testing
class TestProcessLislip(TestCase):
    """
    Test processing lislip for hdf file
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '15cd17b689ba3697a9ab12893785bb5a')
