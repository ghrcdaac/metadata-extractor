...
class TestProcessGeoER(TestCase):
    ...
    """
    granule_name = "GOESR_CRS_L1B_20170507_v0.nc"
    input_file = path.join(path.dirname(__file__), f"fixtures/{granule_name}")
    time_var_key = 'time'
    lon_var_key = 'lon'
    lat_var_key = 'lat'
    time_units = 'units'
    process_goesrpltcrs = mdx.ExtractGeosrpltcrsMetadata(input_file)
    expected_metadata = {'ShortName': 'goesrpltcrs',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2017-05-07T16:08:45Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2017-05-07T16:08:45Z")
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, 'dc9af8acabf7888ee6d83ffec39584d5')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_goesrpltcrs.get_metadata(ds_short_name='goesrpltcrs',
