...
class ExtractHamsrcpexawMetadata(ExtractNetCDFMetadata):
    """
    ...
    def get_variables_min_max(self, nc):
        ...
        :return:
        """
        time_ref_comment = 'seconds since 2000-01-01 00:00:00.0'
        time_ref = datetime.strptime(time_ref_comment,'seconds since %Y-%m-%d %H:%M:%S.%f')
        if '_RAT.nc' in self.file_path:
           time_arr = nc.variables['SCANTIME'][:]
