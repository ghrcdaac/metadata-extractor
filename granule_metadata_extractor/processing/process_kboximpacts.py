...
class ExtractKboximpactsMetadata(ExtractNetCDFMetadata):
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/kboximpactsRefData.json'), 'r') as fp:
...
if __name__ == '__main__':
    print('Extracting kboximpacts Metadata')
    path_to_file = "/ftp/ops/public/pub/fieldCampaigns/impacts/NEXRAD/KBOX/data/20200107/IMPACTS_nexrad_20200107_003948_kbox.nc"
    exnet = ExtractKboximpactsMetadata(path_to_file)
