...
class ExtractKbufimpactsMetadata(ExtractNetCDFMetadata):
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/kbufimpactsRefData.json'), 'r') as fp:
...
if __name__ == '__main__':
    print('Extracting kbufimpacts Metadata')
    path_to_file = "/ftp/ops/public/pub/fieldCampaigns/impacts/NEXRAD/KBUF/data/20200110/IMPACTS_nexrad_20200110_005704_kbuf.nc"
    exnet = ExtractKbufimpactsMetadata(path_to_file)
