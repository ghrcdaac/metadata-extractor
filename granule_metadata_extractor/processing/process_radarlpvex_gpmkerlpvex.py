...
class ExtractGpmkerlpvexMetadata(ExtractASCIIMetadata):
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/gpmkerlpvexRefData.json'), 'r') as fp:
...
# if __name__ == '__main__':
    # print('Extracting Gpmkerlpvex Metadata')
    # path_to_file = "../test/fixtures/lpvex_RADAR_KERAVA_UF_20100921.tar.gz"
