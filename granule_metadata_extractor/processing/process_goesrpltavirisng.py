...
class ExtractGoesrpltavirisngMetadata(ExtractASCIIMetadata):
    """
    A class to extract goesrpltavirisng
    """
    ...
    def get_temporal_lookup(self, granule_name):
        ...
        :return: start_date, stop_date
        """
        start_date, stop_date = self.goesrpltavirisng_loc.get(granule_name).get('temporal')
        return start_date, stop_date
