...
class ExtractLpvexwrfMetadata(ExtractBrowseMetadata):
    """
    A class to extract lpvexwrf
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/lpvexwrfRefData.json'), 'r') as fp:
...
if __name__ == '__main__':
    ...
    exnet = ExtractLpvexwrfMetadata(path_to_file)
