...
class ExtractKmhximpactsMetadata(ExtractNetCDFMetadata):
    """
    A class to extract kmhximpacts 
    """
...
if __name__ == '__main__':
    ...
    path_to_file = "../../test/fixtures/IMPACTS_nexrad_20200105_003725_kmhx.nc"
    exnet = ExtractKmhximpactsMetadata(path_to_file)
