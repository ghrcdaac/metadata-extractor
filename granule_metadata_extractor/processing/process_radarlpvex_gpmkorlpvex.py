...
class ExtractGpmkorlpvexMetadata(ExtractASCIIMetadata):
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/gpmkorlpvexRefData.json'), 'r') as fp:
...
# if __name__ == '__main__':
    ...
    # path_to_file = "../test/fixtures/lpvex_RADAR_KORPO_UF_20101019.tar.gz"
