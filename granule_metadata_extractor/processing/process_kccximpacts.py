...
class ExtractKccximpactsMetadata(ExtractNetCDFMetadata):
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/kccximpactsRefData.json'), 'r') as fp:
...
if __name__ == '__main__':
    print('Extracting kccximpacts Metadata')
    path_to_file = "/ftp/ops/public/pub/fieldCampaigns/impacts/NEXRAD/KCCX/data/20200110/IMPACTS_nexrad_20200110_011917_kccx.nc"
    exnet = ExtractKccximpactsMetadata(path_to_file)
