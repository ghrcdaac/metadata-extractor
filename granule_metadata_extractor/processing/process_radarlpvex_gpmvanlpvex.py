...
class ExtractGpmvanlpvexMetadata(ExtractASCIIMetadata):
    """
    ...
    def __init__(self, file_path):
        ...
        with open(os.path.join(pathlib.Path(__file__).parent.absolute(),
                               '../src/helpers/gpmvanlpvexRefData.json'), 'r') as fp:
...
# if __name__ == '__main__':
    # print('Extracting Gpmvanlpvex Metadata')
    # path_to_file = "../test/fixtures/lpvex_RADAR_VANTAA_RAW_20100916.tar.gz"
    # exnet = ExtractGpmvanlpvexMetadata(path_to_file)
