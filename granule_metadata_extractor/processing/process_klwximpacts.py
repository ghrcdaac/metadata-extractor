...
class ExtractKlwximpactsMetadata(ExtractNetCDFMetadata):
    """
    A class to extract klwximpacts 
    """
...
if __name__ == '__main__':
    ...
    path_to_file = "../../test/fixtures/IMPACTS_nexrad_20200108_002657_klwx.nc"
    exnet = ExtractKlwximpactsMetadata(path_to_file)
