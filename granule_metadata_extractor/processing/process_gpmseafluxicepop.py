...
class ExtractGpmseafluxicepopMetadata(ExtractNetCDFMetadata):
    """
    A class to extract gpmseafluxicepop
    """
    ...
    def get_temporal_lookup(self, granule_name):
        ...
        :return: start_date, stop_date
        """
        start_date, stop_date = self.gpmseafluxicepop_loc.get(granule_name).get('temporal')
        return start_date, stop_date
...
if __name__ == '__main__':
    print('Extracting Gpmseafluxicepop Metadata')
    path_to_file = r"C:\Users\xli\xli\GHRC_cloud\tmp\seafluxicepop\SeaFluxV3_ICEPOP_025x025.nc4.gz"
    exnet = ExtractGpmseafluxicepopMetadata(path_to_file)
