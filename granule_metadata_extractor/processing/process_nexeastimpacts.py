...
class ExtractNexeastimpactsMetadata(ExtractNetCDFMetadata):
    """
...
if __name__ == '__main__':
    print('Extracting Nexeastimpacts Metadata')
    file_path = "/home/lwang13/GHRCCLOUD/granule-metadata-extractor/test/fixtures/IMPACTS_nexrad_20200101_235800_mosaic_east.nc" 
    exnet = ExtractNexeastimpactsMetadata(file_path)
