...
# https://ghrc.nsstc.nasa.gov/hydro/details/gpmkdvn2ifld
nlat = 45.75
slat = 37.47
wlon = -96.1
elon = -85.06
...
if __name__ == "__main__":
    file_dir = "/ftp/ops/public/pub/fieldCampaigns/gpmValidation/ifloods/NEXRAD2/KDVN/data/"
    #(1) read in metadata Mary extracted from database
    with open('gpmkdvn2ifld_dbmeta_redone','r') as fp:
         dbmeta = json.load(fp)

    #(2) read the list of renamed files
    rn_files, old_files, new_files = load_renaming_script('KDVN_renaming_script')
    ...
    with open('../gpmkdvn2ifldRefData.json', 'w') as fp:
