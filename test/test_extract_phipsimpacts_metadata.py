...
class TestProcessPhipsimpacts(TestCase):
    """
    Test processing.
    This will test if metadata will be extracted correctly
    """
    granule_name = "IMPACTS_PHIPS_20200201_1109_20200201113854_000006_C2.png"
    ...
    process_dataset = ExtractPhipsimpactsMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'phipsimpacts')
    expected_metadata = {'ShortName': 'phipsimpacts',
    ...
    def test_1_get_start_date(self):
        ...
        self.assertEqual(start_date, "2020-02-01T11:09:00Z")
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2020-02-01T11:38:54Z")
    ...
    #NLat=37.9854064,SLat=37.6191477,WLon=-75.6949096,ELon=-75.4473907
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, '04d0a00b4d140f0717755b227d1ce164')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='phipsimpacts',
