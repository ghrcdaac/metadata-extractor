...
class TestProcessGpmikalpvex(TestCase):
    """
    Test processing the dataset.
    This will test if metadata will be extracted correctly
    """
    granule_name = "lpvex_RADAR_IKAALINEN_UF_20101019.tar.gz"
    ...
    process_dataset = ExtractGpmikalpvexMetadata(input_file)
    md = process_dataset.get_metadata(ds_short_name= 'gpmikalpvex')
    expected_metadata = {'ShortName': 'gpmikalpvex',
    ...
    def test_2_get_stop_date(self):
        ...
        self.assertEqual(stop_date, "2010-10-19T11:06:14Z")
    ...
    def test_3_get_file_size(self):
        ...
        self.assertEqual(file_size, 534.97)
    ...
    def test_8_get_checksum(self):
        ...
        self.assertEqual(checksum, 'e59bd8003c30167af47b0d5712fffbe2')
    ...
    def test_9_generate_metadata(self):
        ...
        metadata = self.process_dataset.get_metadata(ds_short_name='gpmikalpvex',
